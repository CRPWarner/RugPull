...
# TEMP_WORKING_DIR = "./groundtruth/0123_2247"
# TEMP_WORKING_DIR = "./large/0123_2308"
...
try:
    ...
    if analytics_sums_sorted:
        ...
        #     log("  {}: {}".format(res, sums))
        print('Hidden Mint Function: ', 'HiddenMintFunction' in all_files)
        print('Leaking Token: ', 'LeakingToken' in all_files)
        print('Limiting Sell Order: ', 'LimitingSellOrder' in all_files)
        log('\n')
